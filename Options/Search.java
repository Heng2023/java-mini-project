...
public class Search {
    public static void search(List<ProductsInfo> products, int currentPage, int rowsPerPage) {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Search product by keyword: ");
        String searchKeyword = scanner.nextLine().toLowerCase();

        List<ProductsInfo> matchingProducts = new ArrayList<>();
        ...
        if (matchingProducts.isEmpty()) {
            ...
            for (int i = startIndex; i < endIndex; i++) {
                ProductsInfo product = matchingProducts.get(i);
