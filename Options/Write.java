...
public class Write {
    public static void write(List<ProductsInfo> products){
        ProductsInfo lastProduct = products.get(products.size() - 1);
        ...
        try {
            ...
            ProductsInfo product = new ProductsInfo(productID, productName, productPrice, productQty, LocalDate.now());
